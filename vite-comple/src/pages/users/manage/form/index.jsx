...
import { ManageAction } from "components/widgets/actions";
    ...
    <FormContainer>
      <FormFlexRow>
        ...
        <FieldController
          name="role"
          control={control}
          rules={{ required: { value: true, message: "Please provide role" } }}>
      ...
      <FormFlexRow>
        <FieldController
          ...
          control={control}
          rules={{
            required: { value: true, message: "Please provide first name" },
          }}>
      ...
      <FormFlexRow>
        <FieldController
          ...
          control={control}
          rules={{
            required: { value: true, message: "Please provide mobile number" },
          }}>
      ...
      <FieldController
        name="is_active"
        control={control}
        rules={{ required: { value: true, message: "Please provide active" } }}>
...
Form.propTypes = { instance: PropTypes.object, is_update: PropTypes.bool };

Form.defaultProps = { instance: {}, is_update: false };
